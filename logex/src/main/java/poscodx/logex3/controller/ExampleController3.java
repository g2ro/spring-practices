...
public class ExampleController3 {
	...
	public String ex2() {
		 ...
		 *  
		 *  1. fileAppender3 와 "poscodx.logex3.logex3" logger 를 살펴 보아야 합니다.
		 *  
		 *  2. fileAppender3 에서는 /User/사용자명/logexample/logex3.log 로그파일 지정과
		 *  
		 *  3. 1MB 가 넘었을 때, /User/사용자명/logexample/logex3.x.log.zip 으로 압축되고 새로 
